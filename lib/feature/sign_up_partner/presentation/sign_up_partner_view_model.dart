...
class SignUpPartnerViewModel extends ChangeNotifier {
  ...
  final StreamController<SignUpPartnerEvent> _eventController =
      StreamController<SignUpPartnerEvent>();

  Stream<SignUpPartnerEvent> get eventStream => _eventController.stream;

  Future<void> onAction(SignUpPartnerAction action) async {
    switch (action) {
      case TapBackButton():
        break;
  ...
  Future<void> _submit() async {
    ...
    if (validationErrorMessage != null) {
      _eventController.add(
        SignUpPartnerEvent.showSignUpError(validationErrorMessage),
      );
      return;
    }
    ...
    try {
      ...
      _eventController.add(SignUpPartnerEvent.showSignUpError(e.message));
    } catch (e) {
      _eventController.add(
