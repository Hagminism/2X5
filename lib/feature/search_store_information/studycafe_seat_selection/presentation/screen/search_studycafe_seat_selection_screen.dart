...
class SearchStudycafeSeatSelectionScreen extends StatelessWidget {
  final SearchStudycafeSeatSelectionState state;
  final void Function(SearchStudycafeSeatSelectionAction action) onAction;

  const SearchStudycafeSeatSelectionScreen({
    super.key,
    required this.state,
  ...
  Widget build(BuildContext context) {
    final StudyCafeSeat? selected = selectedSeatForSearchState(state);
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          onPressed: () {
            onAction(const SearchStudycafeSeatSelectionAction.tapBack());
          },
        ),
        title: const Text(
          '좌석 선택',
        ...
        children: [
          ...
          if (selected != null)
            SeatSelectionBottomActionBar(
              ...
              onConfirmPressed: () {
                onAction(
                  SearchStudycafeSeatSelectionAction.tapConfirmSelection(
                    seatId: selected.seatId,
                    seatLabel: seatLabelForSearchDisplay(selected),
                  ),
                );
              },
            ),
  ...
  Widget _buildBody(BuildContext context) {
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              TextButton(
                onPressed: () {
                  onAction(const SearchStudycafeSeatSelectionAction.tapRetry());
                },
    ...
    return SeatSelectionLayoutCanvas(
      ...
      onSeatTap: (String seatId) {
        onAction(SearchStudycafeSeatSelectionAction.tapSeat(seatId));
      },
    );
  }
}
...
String seatLabelForSearchDisplay(StudyCafeSeat seat) {
