...
class SearchStudycafePassSelectionSubmitBar extends StatelessWidget {
  final bool enabled;
  final bool isSubmitting;
  final void Function(SearchStudycafePassSelectionAction action) onAction;

  const SearchStudycafePassSelectionSubmitBar({
    super.key,
        ...
        child: SizedBox(
          ...
          child: ElevatedButton(
            onPressed: !enabled || isSubmitting
                ...
                : () {
                    onAction(
                      const SearchStudycafePassSelectionAction.tapSubmit(),
                    );
                  },
