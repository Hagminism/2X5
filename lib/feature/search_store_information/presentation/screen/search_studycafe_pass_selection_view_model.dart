...
class SearchStudycafePassSelectionViewModel extends ChangeNotifier {
  SearchStudycafePassSelectionViewModel({
    ...
    required AuthRepository authRepository,
       ...
       _state = SearchStudycafePassSelectionState(
         storeId: '',
         seatId: '',
         seatLabel: '',
  ...
  SearchStudycafePassSelectionState _state;

  SearchStudycafePassSelectionState get state => _state;
  ...
  bool get canSubmit {
    final SearchStudycafePassSelectionState s = _state;
  ...
  void onAction(SearchStudycafePassSelectionAction action) {
    switch (action) {
      case SearchStudycafePassTapRetry():
        unawaited(_retryAfterFailure());
        break;
      case SearchStudycafePassTapSelectUsageOption(:final durationMinutes):
