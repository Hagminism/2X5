...
class MapStoreInformationScreen extends StatelessWidget {
          ...
          child: Scaffold(
            ...
            appBar: AppBar(
              ...
              leading: IconButton(
                ...
                onPressed: () {
                  onAction(const MapStoreInformationAction.tapBack());
                },
              ),
              actions: [
                IconButton(
                  ...
                  onPressed: () {
                    onAction(const MapStoreInformationAction.tapShare());
                  },
                ),
                IconButton(
                  icon: Icon(
                  ...
                  onPressed: () {
                    onAction(const MapStoreInformationAction.tapBookmark());
                  },
                ),
              ],
            ),
