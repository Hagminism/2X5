...
String mapStudycafePassUsageOptionTitle(StudyCafeUsageOption option) {
...
String mapStudycafePassUsageOptionPriceLabel(StudyCafeUsageOption option) {
  return '${option.price}원';
}

class MapStudycafePassSelectionUsageOptionList extends StatelessWidget {
  final List<StudyCafeUsageOption> options;
  final int? selectedDurationMinutes;
  final void Function(MapStudycafePassSelectionAction action) onAction;

  const MapStudycafePassSelectionUsageOptionList({
    super.key,
      ...
      itemBuilder: (BuildContext context, int index) {
        ...
        return Padding(
          ...
          child: InkWell(
            onTap: () {
              onAction(
                MapStudycafePassSelectionAction.tapSelectUsageOption(
                ...
                children: [
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        Text(
                          mapStudycafePassUsageOptionTitle(option),
                          style: TextStyle(
                            fontSize: 18,
                        ...
                        Text(
                          mapStudycafePassUsageOptionPriceLabel(option),
                          style: TextStyle(
                            fontSize: 15,
                            color: isSelected
                                ? AppColors.primary
