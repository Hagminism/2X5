...
class MapStudycafePassSelectionSubmitBar extends StatelessWidget {
  final bool enabled;
  final bool isSubmitting;
  final void Function(MapStudycafePassSelectionAction action) onAction;

  const MapStudycafePassSelectionSubmitBar({
    super.key,
        ...
        child: SizedBox(
          ...
          child: ElevatedButton(
            onPressed: !enabled || isSubmitting
                ? null
                : () {
                    onAction(const MapStudycafePassSelectionAction.tapSubmit());
                  },
