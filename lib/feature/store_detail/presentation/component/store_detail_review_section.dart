...
class StoreDetailReviewSection extends StatelessWidget {
  final AiReviewSummary? aiSummary; // AI 요약 데이터 (null일 경우 로딩 혹은 미표시)
    ...
    return Column(
      ...
      children: [
          ...
          children: [
            Expanded(
              child: _ExternalReviewButton(
                ...
                onTap: () => DeepLinkUtil.launchNaverMapReview('11591675'),
            ...
            Expanded(
              child: _ExternalReviewButton(
                ...
                onTap: () => DeepLinkUtil.launchGoogleMapSearch('한성대학교'),
        ...
        ListView.separated(
          ...
          separatorBuilder: (_, __) => const Divider(height: 32, color: AppColors.border, thickness: 1),
          itemBuilder: (context, index) {
            return const _InternalReviewItem();
          },
        ),
      ],
    );
