...
sealed class CouponBoxAction with _$CouponBoxAction {
  ...
  const factory CouponBoxAction.selectCategory(String category) = SelectCategory;
  const factory CouponBoxAction.tapUseCoupon(String couponId) = TapUseCoupon;
  const factory CouponBoxAction.confirmUseCoupon(String couponId) = ConfirmUseCoupon;
}
