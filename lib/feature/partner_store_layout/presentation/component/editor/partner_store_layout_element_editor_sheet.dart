...
void showPartnerStoreLayoutElementEditorSheet(
  ...
  showModalBottomSheet<void>(
    ...
    builder: (BuildContext context) {
      return PartnerStoreLayoutElementEditorSheet(
        element: element,
        onAction: onAction,
      );
    },
...
class PartnerStoreLayoutElementEditorSheet extends StatelessWidget {
  final StudyCafeLayoutElement element;
  final void Function(PartnerStoreLayoutAction action) onAction;

  const PartnerStoreLayoutElementEditorSheet({
    super.key,
        ...
        children: [
          TextFormField(
            ...
            onChanged: (String value) => onAction(
              PartnerStoreLayoutAction.changeSelectedElementLabel(value),
            ),
          ),
            ...
            children: [
              Expanded(
                child: TextFormField(
                  ...
                  onChanged: (String value) => onAction(
                    PartnerStoreLayoutAction.changeSelectedElementWidth(
                      value,
                    ),
                  ),
                ),
              ...
              Expanded(
                child: TextFormField(
                  ...
                  onChanged: (String value) => onAction(
                    PartnerStoreLayoutAction.changeSelectedElementHeight(
                      value,
                    ),
                  ),
                ),
          ...
          TextFormField(
            ...
            onChanged: (String value) => onAction(
              PartnerStoreLayoutAction.changeSelectedElementRotation(value),
            ),
          ),
