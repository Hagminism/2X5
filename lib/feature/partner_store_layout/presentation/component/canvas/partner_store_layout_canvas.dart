import 'package:capstone_2026/feature/partner_store_layout/presentation/component/canvas/partner_store_layout_editable_element.dart';
import 'package:capstone_2026/feature/partner_store_layout/presentation/component/canvas/partner_store_layout_editable_seat.dart';
...
class PartnerStoreLayoutCanvas extends StatefulWidget {
  ...
  @override
  State<PartnerStoreLayoutCanvas> createState() =>
      _PartnerStoreLayoutCanvasState();
}

class _PartnerStoreLayoutCanvasState extends State<PartnerStoreLayoutCanvas> {
          ...
          child: Padding(
            ...
            child: SizedBox(
              ...
              child: GestureDetector(
                ...
                onTap: () {
                  widget.onAction(
                    const PartnerStoreLayoutAction.selectSeats([]),
                  );
                  widget.onAction(
                    const PartnerStoreLayoutAction.selectElements([]),
                  );
                },
                ...
                child: Stack(
                  children: [
                    ...
                    for (final element in widget.state.elements)
                      PartnerStoreLayoutEditableElement(
                        element: element,
                    ...
                    for (final seat in widget.state.seats)
                      PartnerStoreLayoutEditableSeat(
                        seat: seat,
  ...
  void _selectItemsInRect({
    ...
    widget.onAction(PartnerStoreLayoutAction.selectSeats(selectedSeatIds));
    widget.onAction(
      PartnerStoreLayoutAction.selectElements(selectedElementIds),
    );
  }
}
