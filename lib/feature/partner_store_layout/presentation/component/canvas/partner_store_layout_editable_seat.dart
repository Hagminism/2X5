...
import 'package:capstone_2026/feature/partner_store_layout/presentation/component/editor/partner_store_layout_seat_editor_sheet.dart';
...
class PartnerStoreLayoutEditableSeat extends StatelessWidget {
  ...
  const PartnerStoreLayoutEditableSeat({
    super.key,
    required this.seat,
  ...
  Widget build(BuildContext context) {
    ...
    return Positioned(
      ...
      child: GestureDetector(
        onTap: () => onAction(
          PartnerStoreLayoutAction.selectSeat(seat.seatId),
        ),
        onLongPress: () {
          onAction(PartnerStoreLayoutAction.selectSeat(seat.seatId));
          showPartnerStoreLayoutSeatEditorSheet(context, seat, onAction);
        },
        onPanUpdate: (DragUpdateDetails details) => onAction(
          PartnerStoreLayoutAction.moveSeat(
            seatId: seat.seatId,
