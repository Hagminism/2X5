...
alter table public.stores
  drop constraint if exists stores_reservation_slot_minutes_check;

alter table public.stores
  add constraint stores_reservation_slot_minutes_check
  check (reservation_slot_minutes in (30, 60));
